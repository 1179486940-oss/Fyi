...
# ── 以下为 v2 增强工具函数 ──────────────────────────
# ============================================================
# @REAL_CODE: 这些工具函数为纯函数，无需替换
# 来自: multi_agent_system_2.0/utils/helpers.py
# 优先级: LOW (已完成)
# ============================================================
...
def resolve_artifact_path(root: str, *parts: str) -> str:
    """拼接 artifact 存储路径，确保每段都是安全的文件名"""
